...
% \includegraphics[width=13cm]{graphs/10. metamask_setup_bob}

% \includegraphics[height=7cm]{graphs/11. metamask_setup_bob}

% \includegraphics[width=13cm]{graphs/12. metamask_setup_alice}
...
% 	\caption{Bob's view of Project Catalog}
% \end{figure}
...
% \begin{figure}[H]
% 	\centering
% 	\includegraphics[widthcm]{graphs/32. bob_forked_github}
% 	\caption{Ganache Deployed Contracts}
% \end{figure}
...
% \begin{figure}[H]
% 	\centering
% 	\includegraphics[width=10cm]{graphs/33. bob_update_readme}
% 	\caption{Bob update README}
% \end{figure}
...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{.32\textwidth}
		...
		% \caption{Bob send Review Request}
	\end{subfigure}
